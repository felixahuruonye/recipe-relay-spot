  ...
  return (
    <div className="fixed inset-0 bg-black z-50 overflow-y-auto">
      ...
      <div className="sticky bottom-0 bg-black/80 backdrop-blur border-t border-white/10 p-4 space-y-3">
        ...
        {/* Promote Button - Only for own posts */}
        {user?.id === post.user_id && (
          <button
            onClick={handlePromote}
            className="w-full bg-gradient-to-r from-cyan-500 to-blue-500 hover:from-cyan-600 hover:to-blue-600 text-black font-bold py-3 rounded-full text-lg transition-all duration-200 transform hover:scale-105"
          >
